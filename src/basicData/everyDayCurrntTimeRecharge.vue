	...
	<section>
		...
		<template>
			<el-table :data="pageTw" border fit highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;" max-height="380" >
				...
				<el-table-column prop="time" label="日期" width="110" sortable >
				</el-table-column>
				<el-table-column prop="day_best" label="当天总和" width="100" sortable>
				</el-table-column>
				<el-table-column prop="a" label="00:00~00:59" width="100" sortable>
				</el-table-column>
				<el-table-column prop="b" label="01:00~01:59" width="100" sortable>
				</el-table-column>
				<el-table-column prop="c" label="02:00~02:59" min-width="100" sortable>
				</el-table-column>
                <el-table-column prop="d" label="03:00~03:59" min-width="100" sortable>
				</el-table-column>
                <el-table-column prop="e" label="04:00~04:59" min-width="100" sortable>
				</el-table-column>
                <el-table-column prop="f" label="05:00~05:59" min-width="100" sortable>
				</el-table-column>
                <el-table-column prop="g" label="06:00~06:59" min-width="100" sortable>
				</el-table-column>
                <el-table-column prop="h" label="07:00~07:59" min-width="100" sortable>
				</el-table-column>
                <el-table-column prop="i" label="08:00~08:59" min-width="100" sortable>
				</el-table-column>
                <el-table-column prop="j" label="09:00~09:59" min-width="100" sortable>
				</el-table-column>
                <el-table-column prop="k" label="10:00~10:59" min-width="100" sortable>
				</el-table-column>
                <el-table-column prop="l" label="11:00~11:59" min-width="100" sortable>
				</el-table-column>
                <el-table-column prop="m" label="12:00~12:59" min-width="100" sortable>
				</el-table-column>
                <el-table-column prop="n" label="13:00~13:59" min-width="100" sortable>
				</el-table-column>
                <el-table-column prop="o" label="14:00~14:59" min-width="100" sortable>
				</el-table-column>
                <el-table-column prop="p" label="15:00~15:59" min-width="100" sortable>
				</el-table-column>
                <el-table-column prop="q" label="16:00~16:59" min-width="100" sortable>
				</el-table-column>
                <el-table-column prop="r" label="17:00~17:59" min-width="100" sortable>
				</el-table-column>
                <el-table-column prop="s" label="18:00~18:59" min-width="100" sortable>
				</el-table-column>
                <el-table-column prop="t" label="19:00~19:59" min-width="100" sortable>
				</el-table-column>
                <el-table-column prop="u" label="20:00~20:59" min-width="100" sortable>
				</el-table-column>
                <el-table-column prop="v" label="21:00~21:59" min-width="100" sortable>
				</el-table-column>
                <el-table-column prop="w" label="22:00~22:59" min-width="100" sortable>
				</el-table-column>
                <el-table-column prop="x" label="23:00~23:59" min-width="100" sortable>
				</el-table-column>
			</el-table>
			<!--工具条-->
